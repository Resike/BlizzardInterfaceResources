...
Enum.BattlepayProductGroupFlagMeta.MaxValue = 4
Enum.BattlepayProductGroupFlagMeta.MinValue = 1
Enum.BattlepayProductGroupFlagMeta.NumValues = 3
...
Enum.ConsoleColorTypeMeta.MaxValue = 10
Enum.ConsoleColorTypeMeta.MinValue = 0
Enum.ConsoleColorTypeMeta.NumValues = 11
...
Enum.MapCanvasPosition.BottomLeft = 0
Enum.MapCanvasPosition.BottomRight = 1
Enum.MapCanvasPosition.TopLeft = 2
Enum.MapCanvasPosition.TopRight = 3

Enum.MapCanvasPositionMeta.MaxValue = 3
Enum.MapCanvasPositionMeta.MinValue = 0
Enum.MapCanvasPositionMeta.NumValues = 4

Enum.MapTransform.IsForFlightMap = 1

Enum.MapTransformMeta.MaxValue = 1
...
Enum.ModelSceneTypeMeta.MaxValue = 9
Enum.ModelSceneTypeMeta.MinValue = 0
Enum.ModelSceneTypeMeta.NumValues = 10
...
Enum.ZoneAbilityTypeMeta.MaxValue = 2
Enum.ZoneAbilityTypeMeta.MinValue = 0
Enum.ZoneAbilityTypeMeta.NumValues = 3